...
function getVendasVendedorByDate(creci, date) {
    return new Promise(async (resolve, reject) => {
        let con = await database.getConnection();
        ...
        con.connect(function (err) {
            ...
            let sql = `SELECT * from vendas WHERE creci_corretor='${creci}' AND data_venda LIKE '%${date.replace('-','/')}'`;
...
module.exports = { storeVenda, getVendas, getVendasVendedor, getVendasByDate, getVendasVendedorByDate }